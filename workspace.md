...
- [Workspace Configuration ](#workspace-configuration-)
    - [Wildcard namespaces](#wildcard-namespaces)
    - [Wildcard namespaces match labels](#wildcard-namespaces-match-labels)
    - [Exact namespaces](#exact-namespaces)
    - [Global Workspace](#global-workspace)
    - [Management Plane Configuration Namespace](#management-plane-configuration-namespace)
    - [Config only namespaces](#config-only-namespaces)
  - [Gateways](#gateways)
  - [Gloo Mesh Addons](#gloo-mesh-addons)
- [WorkspaceSettings](#workspacesettings)
  - [Federation (not recommended in most environments) ](#federation-not-recommended-in-most-environments-)
  - [Eastwest Gateway Selection](#eastwest-gateway-selection)
  - [Import / Export ](#import--export-)
  - [Service Isolation (recommended) ](#service-isolation-recommended-)
